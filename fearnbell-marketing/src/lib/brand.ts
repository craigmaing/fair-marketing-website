...
export const brand = {
  ...
  contact: {
    email: 'hello@fearnbellmarketing.com',
    phone: '+44 20 1234 5678',
    address: 'London, United Kingdom',
    social: {
      twitter: '@fearnbellmkt',
      linkedin: 'fearnbell-marketing',
      github: 'fearnbell-marketing'
    }
  }
}

export const seoDefaults = {
  titleTemplate: '%s | Fearnbell Marketing',
  defaultTitle: 'Fearnbell Marketing - Fair Marketing That Actually Works',
